...
<body>
    ...
    <div class="row">
      <div class="col-6">
        <img src="../pro-images/1.png" alt="">
      </div>
      <div class="col-6 texto">
        <h1 class="titulo">HUAWEI Buds</h1>
        <br>
        <ul>
            <li>Sonido en Alta Resolución</li>
            <li>Ultra Ligeros</li>
            <li>Cómodos y con Cancelación Activa de Ruido</li>
