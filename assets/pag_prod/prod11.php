...
<body>
    ...
    <div class="row">
      <div class="col-6">
        <img src="../pro-images/11.png" alt="">
      </div>
      <div class="col-6 texto">
        <h1 class="titulo">Vinera Whirlpool</h1>
        <br>
        <ul>
            <li>Ajuste de temperatura.</li>
            <li>Ademas Cuenta con iluminación interior</li>
            <li>Esta vinera tiene un rango de temperatura de 6°C a 16°C.</li>
