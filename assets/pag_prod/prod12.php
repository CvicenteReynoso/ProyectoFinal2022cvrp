...
<body>
    ...
    <div class="row">
      <div class="col-6">
        <img src="../pro-images/12.png" alt="">
      </div>
      <div class="col-6 texto">
        <h1 class="titulo">HUAWEI FreeBuds Pro</h1>
        <br>
        <ul>
            <li>Control inteligente con sensor.</li>
            <li>Sistema de tres micrófonos integrados.Sistema de tres micrófonos integrados.</li>
            <li>Carga con cable USB- tipo C.</li>
            <li>Reproducción de hasta 7 horas con ANC apagado.</li>
