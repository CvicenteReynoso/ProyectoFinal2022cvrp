...
<body>
    ...
    <div class="row">
      <div class="col-6">
        <img src="../pro-images/2.png" alt="">
      </div>
      <div class="col-6 texto">
        <h1 class="titulo">HUA FreeBuds</h1>
        <br>
        <ul>
            <li>Conexión Bluetooth 5.2</li>
            <li>Música con ricos detalles y bajo profundo.</li>
            <li>Excelente reducción de ruido.</li>
            <li>Open-Fit 2.0 integrado</li>
        </ul>
      </div>
    </div>
