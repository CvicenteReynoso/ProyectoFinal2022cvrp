...
<body>
    ...
    <div class="row">
      <div class="col-6">
        <img src="../pro-images/5.png" alt="">
      </div>
      <div class="col-6 texto">
        <h1 class="titulo">Samsung QLED</h1>
        <br>
        <ul>
            <li>Pantalla QLED de 32"</li>
            <li>Bisel Personalizable</li>
            <li>Modo Arte</li>
            <li>Diseño de Marco</li>
        </ul>
      </div>
    </div>
