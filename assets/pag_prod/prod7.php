...
<body>
    ...
    <div class="row">
      <div class="col-6">
        <img src="../pro-images/7.png" alt="">
      </div>
      <div class="col-6 texto">
        <h1 class="titulo">Google Chromecast</h1>
        <br>
        <ul>
            <li>Usa tu voz para transmitir desde apps compatibles</li>
            <li>Disfruta de cientos de apps para Android</li>
            <li>Con el navegador Chrome, puedes duplicar la pantalla de tu laptop en la TV. </li>
            <li>Convierte tu tablet Android o iOS en un centro de entretenimiento aún mejor. </li>
        </ul>
      </div>
    </div>
