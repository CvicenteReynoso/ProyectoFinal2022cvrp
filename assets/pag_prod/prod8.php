...
<body>
    ...
    <div class="row">
      <div class="col-6">
        <img src="../pro-images/8.png" alt="">
      </div>
      <div class="col-6 texto">
        <h1 class="titulo">Huawei Watch 3</h1>
        <br>
        <ul>
            <li>Con una impresionante pantalla AMOLED</li>
            <li>Una sensación de fluidez</li>
            <li>La pantalla redondeada ofrecen un aspecto clásico</li>
            <li>Con acabado circular</li>
        </ul>
      </div>
    </div>
