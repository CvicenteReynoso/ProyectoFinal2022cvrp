...
<body>
    ...
    <div class="row">
      <div class="col-6">
        <img src="../pro-images/9.png" alt="">
      </div>
      <div class="col-6 texto">
        <h1 class="titulo">Apple iPad Air 4, 10.9''</h1>
        <br>
        <ul>
            <li>Cuenta con el chip A14 Bionic</li>
            <li>Pantalla de 10.9" con True Tone</li>
            <li>Touch ID en el botón superior</li>
            <li>Cámara de 12MP y una frontal de 7MP</li>
        </ul>
      </div>
    </div>
